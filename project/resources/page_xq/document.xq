...
declare variable $sheet    := doc("../xsl/mei_to_html_public.xsl");
(:declare variable $sheetdoc := doc("/db/apps/mermeid/style/mei_to_html_public.xsl");:)
declare variable $sheetdoc := doc("/db/apps/mermeid/style/mei_to_html_public.xsl");
...
let $html := doc("../html/document.html")
let $head_title := 
...
<html lang="en" xml:lang="en" xmlns="http://www.w3.org/1999/xhtml">
  {layout:head($head_title,
	  ...
	  <script type="text/javascript" src="/project/resources/js/toggle_openness.js">{"
	  "}</script>
	  ),
	  $verovio)}
