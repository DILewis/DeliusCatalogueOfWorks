...
import module namespace loop="http://kb.dk/this/getlist" at "/db/apps/mermeid/project/modules/main_loop.xqm";
import module namespace app="http://kb.dk/this/listapp" at "/db/apps/mermeid/project/modules/list_utils.xqm";
import module namespace filter="http://kb.dk/this/app/filter" at "/db/apps/mermeid/project/modules/filter_utils.xqm";
import module namespace layout="http://kb.dk/this/app/layout" at "/db/apps/mermeid/project/modules/layout.xqm";
...
declare variable $vocabulary := doc("/db/apps/mermeid/project/resources/page_xml/delius-keywords.xml");
(: declare variable $database := concat("/db/cat-site/",$coll,"/data"); :)
(:  :declare variable $database := "./data";:)
declare variable $database := "/db/apps/mermeid/project/data";
declare variable $html     := doc("../html/navigation.html");
...

{
    ...
    let $genres2 := 
      for $genre in 
	  distinct-values($doc//m:workList/m:work/m:classification/m:termList/m:term[contains(string-join($vocabulary//m:termList[@label='level2']/m:term," "),.) and normalize-space(.)!='']/string())
...
(: Composer currently not used :)
   let $composer :=
   	        <div class="composer">{$doc//m:workList/m:work/m:titleStmt/m:respStmt/m:persName[@role='composer']/text()}&#160;</div>
...
<html lang="en">
   { layout:head($html//h:title/text(),(<link rel="stylesheet" type="text/css" href="/project/resources/css/public_list_style.css"/>),false()) } 
    <body class="list_files" role="document">
      ...
      <div class="files_list">
    	...
    	{filter:print-filters($database,string($number),'0', '20',$genre,$query, $list)}
    	</div>
