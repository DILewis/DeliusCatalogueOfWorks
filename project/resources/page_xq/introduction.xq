...
let $html := doc("../html/introduction.html")

let $contents :=
<html xmlns="http://www.w3.org/1999/xhtml">
  {layout:head(concat("Introduction: ",$html//h:title/text()),(<link rel="stylesheet" type="text/css" href="/project/resources/css/mei_to_html_public.css"/>),false())}
  <body class="text">
    <div id="all">
